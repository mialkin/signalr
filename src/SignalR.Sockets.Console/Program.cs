...
var ip = new IPEndPoint(IPAddress.Loopback, 5230);
...
while (true)
{
    ...
    while (true)
    {
        ...
        if (data.StartsWith("GET"))
        {
            ...
            var acceptWebsocket = Convert.ToBase64String(System.Security.Cryptography.SHA1.Create()
                .ComputeHash(Encoding.UTF8.GetBytes(key.Trim() + "258EAFA5-E914-47DA-95CA-C5AB0DC85B11")));
